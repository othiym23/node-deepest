...
var path         = require('path')
  ...
  , tap          = require('tap')
  , test         = tap.test
  , d            = require(path.join(__dirname, '..', 'deepest'))
  ;
...
test("deepest handles all the edge cases", function (t) {
  /*
   *
   * SUCCESS
   *
...
test("after monkeypatching tap", function (t) {
  t.notDeepEqual({}, [], "using deepest (behind notDeepEqual)");
  t.isNotDeepEqual({}, [], "using deepest (behind isNotDeepEqual)");
  t.inequivalent({}, [], "using deepest (behind inequivalent)");
  t.isInequivalent({}, [], "using deepest (behind isInequivalent)");
  t.notEquivalent({}, [], "using deepest (behind notEquivalent)");
  t.isNotEquivalent({}, [], "using deepest (behind isNotEquivalent)");
  t.isNotDeeply({}, [], "using deepest (behind isNotDeeply)");
  t.notDeeply({}, [], "using deepest (behind notDeeply)");
  t.notSame({}, [], "using deepest (behind notSame)");
